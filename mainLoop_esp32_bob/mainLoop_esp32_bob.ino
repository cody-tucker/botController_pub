...
#define MQTT_SERIAL_RECEIVER_CH_ONE "botInstruction/bob"
#define MQTT_SERIAL_RECEIVER_CH_TWO "botRotation/bob"
#define MQTT_SERIAL_RECEIVER_CH_THREE "botDistance/bob"
#define MQTT_SERIAL_RECEIVER_DEBUG "debug/bob"
// set channels for bot to publish to
#define MQTT_SERIAL_PUBLISH_CH_ONE "status/bob"
...
const char* will_message = "ESP_Bob/disconnected";
...
void callback(char* topic, byte *payload, unsigned int length) {
    ...
    if (strcmp(topic,"botInstruction/bob")==0){
   ...
   if (strcmp(topic,"botRotation/bob")==0){
      String content = "rot/";
      //char response = 0;
      for (int i = 0; i < length; i++){
      //response += (char)payload[i];
    ...
    if (strcmp(topic,"botDistance/bob")==0){
      String content = "dist/";
      //char response = 0;
      for (int i = 0; i < length; i++){
      //response += (char)payload[i];
